<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP_Wide.Master" CodeBehind="SolicitudPermisos.aspx.vb" Inherits="Intranet.SolicitudPermisos" %>
                ...
                buttons: {
                    "Guardar Rechazo": function () {
                        if (document.getElementById('txtMotivoRechazo').value == "") {
                            ...
                            window.location = "/SolicitudPermisosRechazo.aspx?id=" + document.getElementById('txtIdSolicitudRechazo').value + "&motivo=" + document.getElementById('txtMotivoRechazo').value + "&tipo=" + document.getElementById('txtTipo').value;
                        }
                    },
                    "Cancelar": function () {
                        $(this).dialog("close");
                    ...
                    <asp:ListView ID="lvSolicitudesAuth" runat="server">
                            ...
                            <div>
                                <table class="general" width="900px" cellpadding="1" cellspacing="0">
                                    <tr class="head">
                                        ...
                                        <th align="left" colspan="2"><asp:LinkButton runat="server" ID="lnkButton4" CommandName="Sort" Text="Acciones" CommandArgument="folio" /></th>
                                    </tr>
                                    <tr class="head2">
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton5" CommandName="Sort" Text="Solicitante" CommandArgument="solicitante" /></th>
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton6" CommandName="Sort" Text="Estatus" CommandArgument="estatus" /></th>
                        ...
                        <ItemTemplate>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even")%>">
                                <td><asp:HyperLink ID="lnkFolio" runat="server" NavigateUrl='<%# "SolicitudPermisosAgregar.aspx?id=" & Eval("id_solicitud")%>' Text='<%# Eval("folio_txt")%>' ></asp:HyperLink></td>
                    ...
                    <asp:ListView ID="lvVerificacionNominas" runat="server">
                        ...
                        <ItemTemplate>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even")%>">
                                ...
                                <td><asp:Label ID="lblEmpresa" runat="server" Text='<%# Eval("empresa") %>'></asp:Label></td>
                                <td colspan="2">
                                    <asp:LinkButton ID="btnCancelar" runat="server" Text="Cancelar" CommandName="btnCancelar" CommandArgument='<%# Eval("id_solicitud") %>' OnClientClick="return confirm('Seguro que desea CANCELAR estas permisos?');"></asp:LinkButton>
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:LinkButton ID="btnVerifica" runat="server" Text="Verificada" CommandName="btnVerifica" CommandArgument='<%# Eval("id_solicitud") %>' OnClientClick="return confirm('Seguro que desea marcar estas permisos como verificadas?');"></asp:LinkButton>
                                </td>
                            </tr>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                <td><asp:Label ID="lblSolicitante" runat="server" Text='<%# Eval("solicitante")%>'></asp:Label></td>
