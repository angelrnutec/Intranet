.<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepFinancierosEjecutivoFibrasAlternoImpresion.aspx.vb" Inherits="Intranet.RepFinancierosEjecutivoFibrasAlternoImpresion" %>
...
%>
	...
	<script type="text/javascript">
	    $(function () {
            ...
            Dim Fin_Total As Integer = Fin_ContratacionDeudaBancaria + Fin_AmortizacionPasivo + Fin_PagoInteresesBancarios + Fin_Intercompanias
            ...
            <tr valign="top">
                ...
                <td class="noborder">
                    <table border="0" style="border:none">
                        ...
                        <tr>
                            <td class="noborder"><%=TranslateLocale.text("Capex, neto")%></td>
                            <td class="noborder" align="right"><%= IIf(Inv_Capex > 0, Inv_Capex.ToString("#,###,###"), "<span style='color:red'>(" & Math.Abs(Inv_Capex).ToString("#,###,###") & ")</span>")%></td>
                        </tr>
                        <tr>
                            <td class="noborder" style="border-bottom:1px dotted !important;border-color:#000;"><%=TranslateLocale.text("Dividendos, neto")%></td>
                            <td class="noborder" align="right" style="border-bottom:1px dotted !important;border-color:#000;"><%= IIf(Inv_Dividendos > 0, Inv_Dividendos.ToString("#,###,###"), "<span style='color:red'>(" & Math.Abs(Inv_Dividendos).ToString("#,###,###") & ")</span>")%></td>
                        </tr>
                        <tr>
                            <td class="noborder">Total</td>
                ...
                <td class="noborder">
                    <table border="0" style="border:none">
                        ...
                        <tr>
                            <td class="noborder" style="border-bottom:1px dotted !important;border-color:#000;"><%=TranslateLocale.text("INTERCOMPAÑÍAS. CxC (-) CxP, facturas fiscales y préstamos")%></td>
...
<% 
    ...
    <br /><br />
        ...
        %>
            ...
            <table id="tblReporte_29_2" border="1" cellpadding="0" cellspacing="0" width="888px">
                <tr class="filaTotales">
                    <td rowspan="2" align="center" class="titulos2"><b><%=TranslateLocale.text("CONCEPTO")%></b></td>
                    <td>&nbsp;</td>
        ...
        %>
            ...
            <table id="tblReporte_29_6" border="1" cellpadding="0" cellspacing="0" width="888px">
                <tr class="filaTotales">
                    <td rowspan="2" align="center" class="titulos2"><b><%=TranslateLocale.text("CONCEPTO")%></b></td>
                    <td>&nbsp;</td>
