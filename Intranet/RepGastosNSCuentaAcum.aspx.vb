...
Public Class RepGastosNSCuentaAcum
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            Dim url As String = ""
            url = "RepGastosNSCuentaAcumImpresion.aspx?e=6&a=" & Me.ddlAnio.SelectedValue & "&mon=" & Me.ddlMoneda.SelectedValue & "&m=" & Me.ddlMes.SelectedValue
