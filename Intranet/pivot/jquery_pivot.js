...
var methods = {
  ...
  build_containers : function(){
    ...
    var containers = '<div class="pivot_header_fields">' +
                     ...
                     '  <span class="pivot_header2">Filtros</span>' +
                     '   <div id="filter-list"></div>' +
                     '  </div>' +
                     '  <div class="pivot_field">' +
                     '  <span class="pivot_header2">Datos para Filas</span>' +
                     '   <div id="row-label-fields"></div>' +
                     '  </div>' +
                     '  <div class="pivot_field">' +
                     '  <span class="pivot_header2">Datos para Columnas</span>' +
                     '   <div id="column-label-fields"></div>' +
                     '  </div>' +
                     '  <div class="pivot_field">' +
                     '  <span class="pivot_header2">Datos para Totales</span>' +
  ...
  update_result_details : function(){
    ...
    if ($('#pivot-detail').length !== 0)
      snip += '<b>Filtros Aplicados:</b> '    + filters + "<br/>"
  ...
  update_results : function(){
    ...
    snip += '</thead></tr><tbody id="result-rows"></tbody><tfoot id="result-row-foot" style="font-weight:bold"></tfoot></table>';
    result_table.append(snip);

    result_rows = $('#result-rows');
    var result_row_foot = $('#result-row-foot');
    var foot_row;
    ...
    result_row_foot.append(foot_row);
