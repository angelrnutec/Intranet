...
Public Class RepGastosNSEjecutivoNegocio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            Me.CargaCombos()
            Me.lblNombreReporte.Text = "Reporte Ejecutivo Negocio"
        End If
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Dim url As String = ""
            url = "RepGastosNSEjecutivoNegocioImpresion.aspx?a=" & Me.ddlAnio.SelectedValue & "&m=" & Me.ddlMes.SelectedValue & "&mon=" & Me.ddMoneda.SelectedValue
