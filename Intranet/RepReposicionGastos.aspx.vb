...
Public Class RepReposicionGastos
    ...
    Private Sub CargaCombos()
        Try
            ...
            'Me.ddlEmpresa.DataSource = combos.RecuperaEmpresaRepSolicitudes(Session("idEmpleado"), "rep_rep_gas")
            'Me.ddlEmpresa.DataValueField = "id_empresa"
            'Me.ddlEmpresa.DataTextField = "nombre"
            'Me.ddlEmpresa.DataBind()


            'Me.ddlEstatus.DataSource = combos.RecuperaEstatusRepReposicionGastos()
            'Me.ddlEstatus.DataValueField = "id_estatus"
            ...
            Me.ddlEstatus.Items.AddRange(Funciones.DatatableToList(combos.RecuperaEstatusRepReposicionGastos(), "descripcion", "id_estatus"))
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Dim url As String
            url = "RepReposicionGastosImpresion.aspx?fec_ini=" & CType(Me.dtFechaIni.SelectedDate, Date).ToString("yyyyMMdd") _
