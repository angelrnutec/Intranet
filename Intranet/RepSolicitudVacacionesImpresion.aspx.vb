...
Public Class RepSolicitudVacacionesImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not fec_ini Is Nothing And
                ...
                Not id_empleado Is Nothing And
                Not cancelada Is Nothing Then

                Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                Dim tabla As DataTable = reporte.ReporteSolicitudVacaciones(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteSolicitudVacaciones(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not fec_ini Is Nothing And
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.ReporteSolicitudVacaciones(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale())
        End If
        Return Nothing
    End Function
