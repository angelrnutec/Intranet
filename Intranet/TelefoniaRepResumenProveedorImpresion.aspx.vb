...
Public Class TelefoniaRepResumenProveedorImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not anio Is Nothing And
                ...
                Me.gvReporte.DataSource = telcel.RepTelcelResumenPorProveedor(anio, mes)
...
#End Region
    ...
    Private Sub gvReporte_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvReporte.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            mes_01 += e.Row.Cells(1).Text
            mes_02 += e.Row.Cells(2).Text
            mes_03 += e.Row.Cells(3).Text
            mes_04 += e.Row.Cells(4).Text
            mes_05 += e.Row.Cells(5).Text
            mes_06 += e.Row.Cells(6).Text
            mes_07 += e.Row.Cells(7).Text
            mes_08 += e.Row.Cells(8).Text
            mes_09 += e.Row.Cells(9).Text
            mes_10 += e.Row.Cells(10).Text
            mes_11 += e.Row.Cells(11).Text
            mes_12 += e.Row.Cells(12).Text
            total += e.Row.Cells(13).Text


        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            e.Row.Cells(1).Text = Format(mes_01, "#,###,##0")
            e.Row.Cells(2).Text = Format(mes_02, "#,###,##0")
            e.Row.Cells(3).Text = Format(mes_03, "#,###,##0")
            e.Row.Cells(4).Text = Format(mes_04, "#,###,##0")
            e.Row.Cells(5).Text = Format(mes_05, "#,###,##0")
            e.Row.Cells(6).Text = Format(mes_06, "#,###,##0")
            e.Row.Cells(7).Text = Format(mes_07, "#,###,##0")
            e.Row.Cells(8).Text = Format(mes_08, "#,###,##0")
            e.Row.Cells(9).Text = Format(mes_09, "#,###,##0")
            e.Row.Cells(10).Text = Format(mes_10, "#,###,##0")
            e.Row.Cells(11).Text = Format(mes_11, "#,###,##0")
            e.Row.Cells(12).Text = Format(mes_12, "#,###,##0")
            e.Row.Cells(13).Text = Format(total, "#,###,##0")
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim telcel As New Telcel(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Dim dt As DataTable = telcel.RepTelcelResumenPorProveedor(anio, mes)
