<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP.Master" CodeBehind="NecesidadBusqueda.aspx.vb" Inherits="Intranet.NecesidadBusqueda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlBusqueda" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="600px">
            <tr>
                <td colspan="3"><span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Necesidades")%></span><hr style="margin:0; padding:0;" /></td>
            </tr>
            <tr valign="top">
                <td>
         ...
         <AlternatingRowStyle CssClass="grid_alternating" />
          <Columns>
              <asp:TemplateField HeaderText="Clave" SortExpression="clave">
                  <ItemTemplate>
                      <a href='<%# "/NecesidadVer.aspx?id=" & Eval("id_necesidad")%>'><%# Eval("clave")%></a>
                  </ItemTemplate>
              </asp:TemplateField>
              ...
              <asp:BoundField HeaderText="Tipo" SortExpression="tipo" DataField="tipo" />
          </Columns>
    </asp:GridView>
    <br />    
</asp:Content>
