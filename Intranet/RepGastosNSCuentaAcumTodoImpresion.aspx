<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepGastosNSCuentaAcumTodoImpresion.aspx.vb" Inherits="Intranet.RepGastosNSCuentaAcumTodoImpresion" %>
    ...
    <form id="form1" runat="server">
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" HeaderStyle-CssClass="filaTotales titulos" FooterStyle-CssClass="filaTotales titulos" AlternatingRowStyle-BackColor="#FFFFFF" Width="950px" ShowFooter="true">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="ADMON" DataField="ADMON" SortExpression="ADMON" DataFormatString="{0:#,###,###,###}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                            <asp:BoundField HeaderText="RH" DataField="RH" SortExpression="RH" DataFormatString="{0:#,###,###,###}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                            <asp:BoundField HeaderText="SEG. INT" DataField="SEGINT" SortExpression="SEGINT" DataFormatString="{0:#,###,###,###}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                            <asp:BoundField HeaderText="SISTEMAS" DataField="SISTEMAS" SortExpression="SISTEMAS" DataFormatString="{0:#,###,###,###}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
