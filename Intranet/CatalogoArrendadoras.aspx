<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP.Master" CodeBehind="CatalogoArrendadoras.aspx.vb" Inherits="Intranet.CatalogoArrendadoras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlBusqueda" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="600px">
            <tr>
                <td><span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Arrendadoras")%></span><hr style="margin:0; padding:0;" /></td>
            </tr>
            <tr>
                <td>
                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Arrendadora" CssClass="botones" />
                </td>
            </tr>
        </table>
    </asp:Panel>
         ...
         <AlternatingRowStyle CssClass="grid_alternating" />
          <Columns>
              ...
              <asp:TemplateField HeaderText="Acciones">
                  <ItemTemplate>
                      <div align="center">
                          <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="/images/edit.png" CommandName="edit" ToolTip="Editar" CommandArgument='<%# Bind("id_arrendadora")%>' />
                          &nbsp;
                          <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="/images/delete.png" CommandName="eliminar" ToolTip="Eliminar" CommandArgument='<%# Bind("id_arrendadora")%>' OnClientClick="return confirm('Seguro que desea eliminar este registro?');" />
                          &nbsp;
                          <asp:ImageButton ID="btnSave" runat="server" ImageUrl="/images/save.png" CommandName="save" Visible="false" ToolTip="Guardar" CommandArgument='<%# Bind("id_arrendadora")%>' />
                          &nbsp;
