<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepVacacionesVencidasImpresion.aspx.vb" Inherits="Intranet.RepVacacionesVencidasImpresion" %>
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0"  width="1500px">
                <tr class="filaTotales">
                    <td align="left" style='font-size:18px;padding-left:20px;'><%=TranslateLocale.text("Reporte de Vacaciones Vencidas")%></td>
                </tr>
                <tr>
                    <td align="left" style='font-size:15px;padding-left:50px;'><b><%=TranslateLocale.text("Filtros")%>:</b> <%=DefinicionParametros()%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:ExportToExcel runat="server" ID="ExportToExcel1" GridViewID="gvReporte" ExportFileName="VacacionesVencidas.xls" Text="Exportar a Excel" IncludeTimeStamp="true" />
                        &nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" width="900px" HeaderStyle-CssClass="filaTotales titulos" AlternatingRowStyle-BackColor="#FFFFFF">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Fecha Vencimiento" DataField="fecha_vencimiento" SortExpression="fecha_vencimiento" DataFormatString="{0:dd/MM/yyyy}"/>
                            <asp:BoundField HeaderText="Dias Vencidos" DataField="dias_vencidos" SortExpression="dias_vencidos" />
                        </Columns>
                    </asp:GridView>
                </tr>
            </table>
