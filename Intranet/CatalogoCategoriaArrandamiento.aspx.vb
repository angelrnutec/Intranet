...
Public Class CatalogoCategoriaArrandamiento
    ...
    Private Sub Busqueda()
        Try
            ...
            Me.gvResultados.DataSource = arrendamiento.RecuperaCategoriaArrendamientos()
    ...
    Private Sub gvResultados_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvResultados.RowCommand
        ...
        Try
            ...
            ElseIf e.CommandName = "save" Then
                ...
                Dim arrendamiento As New Arrendamiento(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                arrendamiento.GuardaCategoriaArrendamiento(e.CommandArgument, txtDescripcion.Text.Trim, False)
            ...
            ElseIf e.CommandName = "eliminar" Then
                Dim arrendamiento As New Arrendamiento(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                arrendamiento.GuardaCategoriaArrendamiento(e.CommandArgument, txtDescripcion.Text.Trim, True)
                Me.Busqueda()
            End If
        Catch ex As Exception
            ScriptManager.RegisterStartupScript(Me.Page, Me.Page.GetType, "script", "<script>alert('" & ex.Message.Replace(Chr(34), "").Replace(Chr(39), "") & "');</script>", False)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim arrendamiento As New Arrendamiento(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Dim dv As New DataView(arrendamiento.RecuperaCategoriaArrendamientos())
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            Dim arrendamiento As New Arrendamiento(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            arrendamiento.GuardaCategoriaArrendamiento(0, Me.txtDescripcion.Text.Trim, False)
