<%@ Page MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP_Wide.Master" CodeBehind="SolicitudReposicionAgregar.aspx.vb" Inherits="Intranet.SolicitudReposicionAgregar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CalculaTotal(sender, eventArgs) {
            ...
            if ($find('<%=txtRetencionResico.ClientID%>').get_value() != '') {
                retencion_resico = $find('<%=txtRetencionResico.ClientID%>').get_value();
            }
    ...
    <script type="text/javascript">
        /*$(document).ready(function () {
            setTimeout(function () { ActualizaTipoCambio() }, 500);
        });

        function ActualizaTipoCambio() {
            var tipoCambio = $find('');
            var moneda = document.getElementById('');
            if (moneda.value == "MXP") {
                tipoCambio.set_value(1);
                tipoCambio.disable();
            } else {
                tipoCambio.enable();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="650px">
        <tr>
            <td colspan="5"><span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Solicitud de Reposición de Gastos")%></span><hr style="margin:0; padding:0;" /></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td><asp:DropDownList ID="ddlDeudor" runat="server" Width="200px"></asp:DropDownList></td>
        </tr>
        <tr>
        ...
        <tr id="trAutorizaMateriales" runat="server" visible="false">
            <td><%=TranslateLocale.text("Autoriza Materiales")%>:</td>
            <td colspan="4"><asp:Label ID="lblAutorizaMateriales" runat="server"></asp:Label></td>
        </tr>
        <tr id="trAutorizaOperaciones" runat="server" visible="false">
            <td><%=TranslateLocale.text("Autoriza Operaciones")%>:</td>
            <td colspan="4"><asp:Label ID="lblAutorizaOperaciones" runat="server"></asp:Label></td>
        </tr>
        <tr id="trAutorizaComidasInternas" runat="server" visible="false">
            <td><%=TranslateLocale.text("Autoriza Comidas Internas")%>:</td>
            <td colspan="4"><asp:Label ID="lblAutorizaComidasInternas" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td><%=TranslateLocale.text("Comentarios")%>:</td>
            <td><asp:TextBox ID="txtComentarios" runat="server" TextMode="MultiLine" Height="55px" Width="200px"></asp:TextBox></td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="5">
                ...
                <table id="tblHistAuth" runat="server" visible="false" cellpadding="0" cellspacing="0" border="0" width="395px">
                    ...
                    <tr>
                        <td width="90px"><%=TranslateLocale.text("Autoriza Jefe")%>:</td>
    ...
    <br /><br />
    <asp:Button ID="btnRegresar" runat="server" CssClass="botones" Text="Cancelar" />
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnGuardar" runat="server" Text="Continuar" CssClass="botones" OnClientClick="this.disabled = true; this.value = 'Guardando...';" UseSubmitBehavior="false" />
    &nbsp;&nbsp;&nbsp;
    ...
    <div id="divSolicitudConMateriales" runat="server" visible="false">
        ...
        <div style="color:blue;font-weight:bold;" class="link1">
            ...
            <asp:HyperLink ID="lnkSolicitudGastos" runat="server" CssClass="link1" Target="_blank" Text="De click aquí para abrir la solicitud de gastos en otra ventana."></asp:HyperLink>
        </div>
        <hr />
    </div>
    ...
    <div id="divComprobantes" runat="server" visible="false">
        <table cellpadding="0" cellspacing="0" border="0" width="850px">
            <tr>
                <td colspan="5"><span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Comprobantes de Gastos")%></span><hr style="margin:0; padding:0;" />
            ...
            <div id="divComprobantesAlta" runat="server" visible="false">
                <table width="650px">
                        ...
                        <td colspan="7">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        &nbsp;<asp:DropDownList ID="ddlElementoEmpresa" runat="server" Visible="false"></asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td colspan="5"><asp:TextBox ID="txtObservaciones" runat="server" Width="300px"></asp:TextBox></td>
                    </tr>
                </table>
                <table width="650px">
                    <tr>
             ...
             <AlternatingRowStyle CssClass="grid_alternating" />
              <Columns>
                ...
                <asp:TemplateField HeaderText="Observaciones" SortExpression="observaciones" ItemStyle-Width="140px">
                  ...
                  <asp:TemplateField HeaderText="Ret. Resico" SortExpression="ret">
                    <ItemTemplate>
                        <div align="right">
        ...
        <div id="divTotales" visible="false" runat="server" style="width:630px;text-align:right;">
            <div style="display:inline-block;"><b><asp:Label ID="lblTotal" runat="server" Text="Total MXP" ></asp:Label>:&nbsp;&nbsp;<asp:Label ID="lblTotalMXP" runat="server"></asp:Label></b></div>
        </div>
    ...
    <br /><br />
     ...
     <asp:TextBox ID="txtIdSolicitudReposiciones" runat="server" style="display:none;"></asp:TextBox>
    ...
    <asp:TextBox ID="txtComprobacionOpera" runat="server" Visible="false"></asp:TextBox>
    <asp:TextBox ID="txtComprobacionMater" runat="server" Visible="false"></asp:TextBox>
    <asp:TextBox ID="txtComprobacionComidasInternas" runat="server" Visible="false"></asp:TextBox>
    ...
    <script type="text/javascript">
            ...
            $("#fileuploader").uploadFile({
                ...
                onSuccess: function (files, data, xhr, pd) {
                    if (data.indexOf("Error=").length >= 0) {
                        ...
                        AgregaDocumentos(document.getElementById('<%=txtIdSolicitudReposiciones.ClientID%>').value, data, document.getElementById('txtIdSolicitudDetalleCargar').value);
        ...
        function AgregaDocumentos(id, nombre, id_solicitud_detalle) {
            $.ajax({
                ...
                data: { id: id, id_solicitud_detalle: id_solicitud_detalle, nombre: nombre, tipo: "RG" },
        ...
        function EliminarDocumento(id) {
            if (confirm('Seguro que desea eliminar este archivo?')) {
                $.ajax({
                    ...
                    data: { id: id, tipo: "RG" },
                    success: function (datos) {
                        RecuperaDocumentos(document.getElementById('<%=txtIdSolicitudReposiciones.ClientID%>').value);
                    },
        ...
        function RecuperaDocumentos(id) {
            ...
            $.ajax({
                type: "GET",
                url: "/Servicios/ComprobanteGastos.aspx?id=" + id + "&tipo=RG",
                success: function (datos) {
    ...
    End If
        ...
        <script type="text/javascript">
            ...
            function MovimientosPorComprobar() {
                var id_empleado = document.getElementById('<%=txtIdEmpleadoSolicita.ClientID%>').value;
                    ...
                    close: function (event, ui) {
                        setTimeout(function () {
                            if (GUARDAR_CLICKED == false) {
                                window.location = '/SolicitudReposicionAgregar.aspx?id=' + document.getElementById('<%=txtIdSolicitudReposiciones.ClientID%>').value + '&v=' + new Date().getTime() + '#comprobantes'
                                return false;
                            }
                        }, 200);
                ...
                $("#dialog-form").load('/MovimientosTarjetaPendiente.aspx?id=' + id_empleado + '&t=' + tipo_comprobantes + '&e=' + id_empresa + '&ts=R').dialog("open");
            ...
            function GuardaCambios() {
                ...
                datos['id_solicitud'] = $('#<%=txtIdSolicitudReposiciones.ClientID%>').val();
                datos['tipo'] = 'RG';
