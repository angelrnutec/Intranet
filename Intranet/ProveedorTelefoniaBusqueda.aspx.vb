...
Public Class ProveedorTelefoniaBusqueda
    ...
    Private Sub Busqueda()
        Try
            ...
            Dim dt As DataTable = proveedor_telefonia.Recupera(Me.ddlConcepto.SelectedValue)
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Response.Redirect("/ProveedorTelefoniaVer.aspx?id=0")
    End Sub
