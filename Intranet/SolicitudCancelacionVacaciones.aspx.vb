...
Public Class SolicitudCancelacionVacaciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.btnAgregar.Text = TranslateLocale.text("Agregar Solicitud de Cancelación")
    ...
    Private Sub ListView_SolicitudesAuth(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
    ...
    Private Sub ListView_Solicitudes(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
        sortExpression = sortExpression.Replace("Ascending", "ASC")
        sortExpression = sortExpression.Replace("Descending", "DESC")
    ...
    Private Sub ListView_SolicitudesRealizado(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
        sortExpression = sortExpression.Replace("Ascending", "ASC")
        sortExpression = sortExpression.Replace("Descending", "DESC")
    ...
    'Public Sub ListView_SolicitudesVerificar(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
    '    sortExpression = sortExpression.Replace("Ascending", "ASC")
    '    sortExpression = sortExpression.Replace("Descending", "DESC")
    ...
    'Public Sub ListView_SolicitudesVerificarHistorico(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
    '    sortExpression = sortExpression.Replace("Ascending", "ASC")
    '    sortExpression = sortExpression.Replace("Descending", "DESC")
    ...
    'Public Sub ListView_Vencimientos(solicitud_vacaciones As SolicitudCancelacionVacacion, sortExpression As String)
    '    sortExpression = sortExpression.Replace("Ascending", "ASC")
    '    sortExpression = sortExpression.Replace("Descending", "DESC")
    ...
    Private Sub Busqueda()
        Try
            Dim solicitud_vacaciones As New SolicitudCancelacionVacacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Response.Redirect("SolicitudCancelacionVacacionesAgregar.aspx?id=0")
    End Sub
    ...
    Private Sub lvSolicitudesAuth_ItemCommand(sender As Object, e As ListViewCommandEventArgs) Handles lvSolicitudesAuth.ItemCommand
        Try
            ...
            If e.CommandName = "btnAutorizar" Then
                ...
                ScriptManager.RegisterStartupScript(Me.Page, Me.Page.GetType, "script", "<script>alert('" & TranslateLocale.text("Datos Guardados Correctamente") & "');window.location='SolicitudCancelacionVacaciones.aspx';</script>", False)
    ...
    Private Sub EnviarEmail(ByVal id_solicitud As Integer, autorizado As Boolean)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If autorizado Then
                    email_asunto = TranslateLocale.text("Solicitud de Cancelación de Vacaciones Autorizada", EMAIL_LOCALE) & " (" & dr("folio_txt").ToString() & ")"
                ...
                Else
                    email_asunto = TranslateLocale.text("Solicitud de Cancelación de Vacaciones Rechazada", EMAIL_LOCALE) & " (" & dr("folio_txt").ToString() & ")"
    ...
    '            ScriptManager.RegisterStartupScript(Me.Page, Me.Page.GetType, "script", "<script>window.location='SolicitudCancelacionVacaciones.aspx';</script>", False)
    '        ElseIf e.CommandName = "btnVerifica" Then
    '            Dim id_solicitud As Integer = e.CommandArgument

    '            solicitud_vacaciones.VerificaSolicitud(id_solicitud)
