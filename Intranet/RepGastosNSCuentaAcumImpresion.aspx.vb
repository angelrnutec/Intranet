...
Public Class RepGastosNSCuentaAcumImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not id_empresa Is Nothing And
                ...
                Dim ds As DataSet = reporte.ReporteGastosNSCuentaAcum(id_empresa, anio, mon, Session("idEmpleado"), mes)
    ...
    Private Sub gvReporte_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvReporte.RowDataBound
        If e.Row.RowType = DataControlRowType.Footer Then
            ...
            If total > 0 Then e.Row.Cells(9).Text = Format(total, "#,###,##0")
        End If
    End Sub
