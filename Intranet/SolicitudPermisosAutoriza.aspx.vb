...
Public Class SolicitudPermisosAutoriza
    ...
    Private Sub ProcesaSolicitud()
        ...
        Try
            ...
            If tipo = "1" Then
                If valor = "1" Then
                    solicitud_permisos.CambiaEstatusMail(id_solicitud, id_empleado, tipo, IIf(valor = "1", True, False))

                    If solicitud_permisos.SolicitudTieneGerente(id_solicitud) = True Then
                        EnviarEmailGerente(id_solicitud)
                    Else
                        solicitud_permisos.CambiaEstatusMail(id_solicitud, 0, 2, True)
    ...
    Private Sub btnGuardarRechazo_Click(sender As Object, e As EventArgs) Handles btnGuardarRechazo.Click
        ...
        Dim solicitud_permisos As New SolicitudPermiso(System.Configuration.ConfigurationManager.AppSettings("CONEXION").ToString())
        solicitud_permisos.CambiaEstatusMail(id_solicitud, id_empleado, tipo, IIf(valor = "1", True, False))
        solicitud_permisos.GuardaMotivoRechazo(id_solicitud, Me.txtMotivoRechazo.Text)
