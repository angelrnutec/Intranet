...
Public Class RepGastosNSCentroCosto
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            Dim url As String = ""
            url = "RepGastosNSCentroCostoImpresion.aspx?e=6&a=" & Me.ddlAnio.SelectedValue & "&mon=" & Me.ddlMoneda.SelectedValue & "&m=" & Me.ddlMes.SelectedValue
