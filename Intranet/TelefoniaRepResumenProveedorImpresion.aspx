<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TelefoniaRepResumenProveedorImpresion.aspx.vb" Inherits="Intranet.TelefoniaRepResumenProveedorImpresion" %>
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr class="filaTotales">
                    <td align="left" style='font-size:18px;padding-left:20px;'>Presentación Resumen por Proveedor</td>
                </tr>
                <tr>
                    <td align="left" style='font-size:15px;padding-left:50px;'><b>Filtros:</b> <%=DefinicionParametros()%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:ExportToExcel runat="server" ID="ExportToExcel1" GridViewID="gvReporte" ExportFileName="ResumenPorProveedor_.xls" Text="Exportar a Excel" IncludeTimeStamp="true" />
                        &nbsp;&nbsp;&nbsp;
