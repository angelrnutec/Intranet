...
Public Class SolicitudCancelacionVacacionesRechazo
    ...
    Private Sub ProcesaSolicitud()
        ...
        Try
            ...
            solicitud_vacaciones.CambiaEstatusMail(id_solicitud, Session("idEmpleado"), tipo, False)
            solicitud_vacaciones.GuardaMotivoRechazo(id_solicitud, motivo)
