<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepFinancierosEjecutivoFibrasImpresion.aspx.vb" Inherits="Intranet.RepFinancierosEjecutivoFibrasImpresion" %>
...
<% 
    ...
    <div style='padding-left:12px;font-size:22px;'><asp:Label ID="lblTituloReporte" runat="server"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/RepFinancierosEjecutivoFibrasAlternoImpresion.aspx?a=<%=anio%>&m=<%=mes%>">Ver Formato Presentación</a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/RepFinancierosEjecutivoFibrasAlterno2Impresion.aspx?a=<%=anio%>&m=<%=mes%>">Ver Formato Presentación 2</a>
    </div>
...
<% 
    ...
    <table id="tblReporte_3" border="1" cellpadding="0" cellspacing="0" width="1540px">    
        <tr class="filaTotales">
            ...
            <td>&nbsp;</td>
            <td colspan="6" align="center" class="titulos">NPC</td>
            <td>&nbsp;</td>
...
<% 
    ...
    For Each dr As DataRow In dtRep.Rows
        ...
        Response.Write("<td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & " bordederecho'>" & FormateaValorRep3(dr, 11, 41, 1) & "</td><td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & " bordeizquierdo'>" & FormateaValorRep3(dr, 11, 41, 2) & "</td>")
        colAlterna = Not colAlterna
        Response.Write("<td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & " bordederecho'>" & FormateaValorRep3(dr, 11, 42, 1) & "</td><td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & " bordeizquierdo'>" & FormateaValorRep3(dr, 11, 42, 2) & "</td>")
        colAlterna = Not colAlterna
        Response.Write("<td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & "'>" & FormateaValorRep3(dr, 11, 43, 1) & "</td>")
        colAlterna = Not colAlterna
        Response.Write("<td align='center' class='datos" & IIf(colAlterna, " columnaAlterna", "") & "'>" & FormateaValorRep3(dr, 11, 44, 1) & "</td>")
        Response.Write("<td>&nbsp;</td>")
