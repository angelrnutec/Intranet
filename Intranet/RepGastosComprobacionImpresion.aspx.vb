...
Public Class RepGastosComprobacionImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim tipo_solicitud As String = Request.QueryString("tipo_solicitud")
            Dim elemento_pep As String = Request.QueryString("elemento_pep")


            If Not fec_ini Is Nothing And
                Not fec_fin Is Nothing And
                Not id_empresa Is Nothing And
                Not tipo_solicitud Is Nothing And
                Not elemento_pep Is Nothing Then

                Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                Dim tabla As DataTable = reporte.ReporteSolicitudComprobacion(fec_ini, fec_fin, id_empresa, id_empleado, tipo_solicitud, elemento_pep, Session("idEmpleado")).Tables(0)
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not fec_ini Is Nothing And
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.ReporteSolicitudComprobacion(fec_ini, fec_fin, id_empresa, id_empleado, tipo_solicitud, elemento_pep, Session("idEmpleado"))
        End If
        Return Nothing
    End Function
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteSolicitudComprobacion(fec_ini, fec_fin, id_empresa, id_empleado, tipo_solicitud, elemento_pep, Session("idEmpleado")).Tables(0)
