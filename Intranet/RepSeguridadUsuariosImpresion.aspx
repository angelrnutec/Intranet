<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepSeguridadUsuariosImpresion.aspx.vb" Inherits="Intranet.RepSeguridadUsuariosImpresion" %>
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0"  width="1500px">
                <tr class="filaTotales">
                    <td align="left" style='font-size:18px;padding-left:20px;'>Reporte de Permisos por Empleado</td>
                </tr>
                <tr>
                    <td align="left" style='font-size:15px;padding-left:50px;'>
                        <asp:ExportToExcel runat="server" ID="ExportToExcel1" GridViewID="gvReporte" ExportFileName="SeguridadEmpleado.xls" Text="Exportar a Excel" IncludeTimeStamp="true" />
                    </td>
                </tr>
                <tr>
                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" width="900px" HeaderStyle-CssClass="filaTotales titulos" AlternatingRowStyle-BackColor="#FFFFFF">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Pantalla" DataField="pantalla" SortExpression="pantalla" />
                        </Columns>
                    </asp:GridView>
                </tr>
            </table>
