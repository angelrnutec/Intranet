...
Public Class RepSolicitudPermisos
    ...
    Private Sub CargaCombos()
        Try
            ...
            'Me.ddlEstatus.DataSource = combos.RecuperaEstatusRepPermisos()
            ...
            Me.ddlEstatus.Items.AddRange(Funciones.DatatableToList(combos.RecuperaEstatusRepPermisos(), "descripcion", "id_estatus"))
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Dim url As String
            url = "RepSolicitudPermisosImpresion.aspx?fec_ini=" & CType(Me.dtFechaIni.SelectedDate, Date).ToString("yyyyMMdd") _
