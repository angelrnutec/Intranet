...
Public Class RepVencimientoVacaciones
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Dim url As String
            url = "RepVencimientoVacacionesImpresion.aspx?id_empresa=" & Me.ddlEmpresa.SelectedValue.ToString _
                                                    & "&id_empleado=" & Me.ddlEmpleado.SelectedValue.ToString
