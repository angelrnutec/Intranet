<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP.Master" CodeBehind="RepFinancieros.aspx.vb" Inherits="Intranet.RepFinancieros" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="divAgrupado" runat="server" visible="false" style="display:inline;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td colspan="3" align="right">
                            ...
                            <asp:TextBox ID="txtIdReporte" runat="server" Text="0" Visible="false"></asp:TextBox>
                        </td>
                    </tr>
                </table>
