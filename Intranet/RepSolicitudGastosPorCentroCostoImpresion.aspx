<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepSolicitudGastosPorCentroCostoImpresion.aspx.vb" Inherits="Intranet.RepSolicitudGastosPorCentroCostoImpresion" %>
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr class="filaTotales">
                    <td align="left" style='font-size:18px;padding-left:20px;'><%=TranslateLocale.text("Rep. Solicitud de Gastos por Centro de Costo / Orden Interna")%></td>
                </tr>
                <tr>
                    <td align="left" style='font-size:15px;padding-left:50px;'><b>Filtros:</b> <%=DefinicionParametros()%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:ExportToExcel runat="server" ID="ExportToExcel1" GridViewID="gvReporte" ExportFileName="GastosPorCC_OI_.xls" Text="Exportar a Excel" IncludeTimeStamp="true" />
                        &nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" HeaderStyle-CssClass="filaTotales titulos" FooterStyle-CssClass="filaTotales titulos" AlternatingRowStyle-BackColor="#FFFFFF" ShowFooter="true">
                        <Columns>
                            <asp:BoundField HeaderText="Centro Costo / Orden Interna" DataField="concepto" SortExpression="concepto" />
                            <asp:BoundField HeaderText="Emp" DataField="empresa" SortExpression="empresa" />
