...
Public Class ArrendamientoFactura
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.btnAgregar.Text = TranslateLocale.text("Cargar Factura")
    ...
    Private Sub Busqueda()
        ...
        '        Dim dt As DataTable = arrendamiento.RecuperaArrendamientosFacturas(Me.ddlEmpresa.SelectedValue, Me.ddlCategoriaArrendamiento.SelectedValue)
