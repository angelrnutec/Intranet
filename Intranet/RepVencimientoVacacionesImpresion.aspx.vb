...
Public Class RepVencimientoVacacionesImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not id_empresa Is Nothing And
                ...
                Me.gvReporte.DataSource = vacaciones.RecuperaVencimientosVacaciones(id_empleado, id_empresa, Session("idEmpleado"), 0)
    ...
    Protected Function DefinicionParametros() As String
        ...
        If Not id_empresa Is Nothing And
            ...
            parametros += TranslateLocale.text("Empleado") & ": " & IIf(id_empleado = "0", "Todos", reporte.RecuperaEmpleadoNombre(id_empleado))
