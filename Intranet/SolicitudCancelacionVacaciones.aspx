<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP_Wide.Master" CodeBehind="SolicitudCancelacionVacaciones.aspx.vb" Inherits="Intranet.SolicitudCancelacionVacaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <link rel="stylesheet" type="text/css" href="/styles/styles.css" />
                ...
                buttons: {
                    "Guardar Rechazo": function () {
                        if (document.getElementById('txtMotivoRechazo').value == "") {
                            ...
                            window.location = "/SolicitudCancelacionVacacionesRechazo.aspx?id=" + document.getElementById('txtIdSolicitudRechazo').value + "&motivo=" + document.getElementById('txtMotivoRechazo').value + "&tipo=" + document.getElementById('txtTipo').value;
                        }
                    },
                    "Cancelar": function () {
                        $(this).dialog("close");
   ...
   <style type="text/css">
    ...
    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Solicitud de Cancelacion" CssClass="botones" />
    <br /><br /><br />
                    ...
                    <asp:ListView ID="lvSolicitudesAuth" runat="server">
                            ...
                            <div>
                                <table class="general" width="900px" cellpadding="1" cellspacing="0">
                                    <tr class="head">
                                        ...
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton3" CommandName="Sort" Text="Dias Cancelados" CommandArgument="dias" /></th>
                                    ...
                                    <tr class="head2">
                                        ...
                                        <th align="left" colspan="2"><asp:LinkButton runat="server" ID="lnkButton6" CommandName="Sort" Text="Fechas Canceladas" CommandArgument="fecha_ini" /></th>
                                    </tr>
                        ...
                        <ItemTemplate>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even")%>">
                                <td><asp:HyperLink ID="lnkFolio" runat="server" NavigateUrl='<%# "SolicitudCancelacionVacacionesAgregar.aspx?id=" & Eval("id_solicitud")%>' Text='<%# Eval("folio_txt")%>' ></asp:HyperLink></td>
                            ...
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                ...
                                <td colspan="2"><asp:Label ID="lblFechaIni" runat="server" Text='<%# Eval("fechas") %>'></asp:Label></td>
                            </tr>
                        </ItemTemplate>
                    ...
                    <asp:ListView ID="lvSolicitudes" runat="server">
                            ...
                            <div>
                                <table class="general" width="900px" cellpadding="1" cellspacing="0">
                                    ...
                                    <tr class="head2">
                                        ...
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton5" CommandName="Sort" Text="Dias Cancelados" CommandArgument="dias" /></th>
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton6" CommandName="Sort" Text="Fechas Canceladas" CommandArgument="fecha_ini" /></th>
                                    </tr>
                                    <asp:PlaceHolder runat="server" ID="itemPlaceholder" />
                                </table>
                            </div>
                        ...
                        <ItemTemplate>
                            ...
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                ...
                                <td><asp:Label ID="lblFechaIni" runat="server" Text='<%# Eval("fechas") %>'></asp:Label></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate><br /><br /></EmptyDataTemplate>
                        <ItemSeparatorTemplate></ItemSeparatorTemplate>
