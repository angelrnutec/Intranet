...
Public Class RepSaldoVacacionesImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not id_empresa Is Nothing Then
                ...
                Me.gvReporte.DataSource = reporte.ReporteSaldoVacaciones(id_empresa, Session("idEmpleado"))
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteSaldoVacaciones(id_empresa, Session("idEmpleado")).Tables(0)
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not id_empresa Is Nothing Then
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.ReporteSaldoVacaciones(id_empresa, Session("idEmpleado"))
        End If
        Return Nothing
    End Function
