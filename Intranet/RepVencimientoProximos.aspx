<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP.Master" CodeBehind="RepVencimientoProximos.aspx.vb" Inherits="Intranet.RepVencimientoProximos" %>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td colspan="2"><%=TranslateLocale.text("Vacaciones que se vencen en los proximos")%> <telerik:RadNumericTextBox ID="txtNumDias" runat="server" Value="30" NumberFormat-DecimalDigits="0" Width="30px"></telerik:RadNumericTextBox> <%=TranslateLocale.text("dias")%>.</td>
                    </tr>
                    <tr>
