...
Public Class EnvioSolicitudGastoComprobantes
    ...
    Private Sub CargaFormulario(rechazo As String)
        ...
        If dt.Rows.Count > 0 Then
            ...
            If rechazo = "1" Then
                lblTitulo.Text = TranslateLocale.text("Sus Comprobantes de Viaje han sido rechazados:", EMAIL_LOCALE)
            ElseIf rechazo = "2" Then
                lblTitulo.Text = TranslateLocale.text("Solicitud de Gastos rechazada:", EMAIL_LOCALE)
            Else
                lblTitulo.Text = TranslateLocale.text("Solicitud de Autorizacion de Comprobantes de Viaje con la siguiente informacion", EMAIL_LOCALE)
            End If
            ...
            Else
                If Me.lblTipo.Text = "J" Then
                    lblNombre.Text = dr("autoriza_jefe").ToString()
                Else
            ...
            If (rechazo = "1" Or rechazo = "2") And Not IsDBNull(dr("estatus_comentarios")) Then
            ...
            Else
                ...
                lnkAutoriza.HRef = url_base & "SolicitudGastosAutoriza.aspx?auth=1" & valores
                lnkRechaza.HRef = url_base & "SolicitudGastosAutoriza.aspx?auth=0" & valores
