...
Public Class EnvioErrorTicketEmpresarial
    ...
    Private Sub CargaFormulario()
        ...
        If dt.Rows.Count > 0 Then
            ...
            lblTitulo.Text = TranslateLocale.text("ERROR AL ASIGNAR FONDOS", EMAIL_LOCALE) & "<br>" & Request.QueryString("ticket_empresarial")
