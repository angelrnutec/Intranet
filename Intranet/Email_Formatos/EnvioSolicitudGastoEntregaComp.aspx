<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnvioSolicitudGastoEntregaComp.aspx.vb" Inherits="Intranet.EnvioSolicitudGastoEntregaComp" %>
                              ...
                              <asp:TemplateField HeaderText="Observaciones" SortExpression="observaciones">
                                <ItemTemplate>
                                    <div>
                                        ...
                                        <br />Num. Personas: <asp:Label ID="lblNumPersonas" runat="server" Text='<%# Eval("num_personas")%>' />
