<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnvioSolicitudReposicion.aspx.vb" Inherits="Intranet.EnvioSolicitudReposicion" %>
    ...
    <table width="600px">
        ...
        <tr>
            <td align="center">
                <table width="90%">
                    <tr>
                        <td align="left" style="width:180px;"><%=TranslateLocale.text("Folio", EMAIL_LOCALE)%>:</td>
                    ...
                    <tr>
                        <td colspan="2" align="left" style="width:160px;">
                            ...
                            <a id="lnkAutoriza" runat="server" target="_blank"><%=TranslateLocale.text("Autorizar Comprobantes", EMAIL_LOCALE)%></a>
                            &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                            <a id="lnkRechaza" runat="server" target="_blank"><%=TranslateLocale.text("Rechazar Comprobantes", EMAIL_LOCALE)%></a>
                            <br /><br />
