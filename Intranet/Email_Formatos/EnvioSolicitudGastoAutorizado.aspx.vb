...
Public Class EnvioSolicitudGastoAutorizado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If Not Request.QueryString("id") Is Nothing Then
                ...
                Me.lblTipo.Text = Request.QueryString("tipo")
                Me.CargaFormulario(Request.QueryString("tipo"))
            End If

        End If
    End Sub

    Private Sub CargaFormulario(tipo As String)
        ...
        If dt.Rows.Count > 0 Then
            ...
            Else
                lblTitulo.Text = TranslateLocale.text("Solicitud Autorizada por", EMAIL_LOCALE) & " " & IIf(tipo = 1, TranslateLocale.text("Jefe Directo", EMAIL_LOCALE), TranslateLocale.text("Contabilidad", EMAIL_LOCALE))
            End If
