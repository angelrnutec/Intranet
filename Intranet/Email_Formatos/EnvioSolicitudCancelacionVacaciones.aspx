<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnvioSolicitudCancelacionVacaciones.aspx.vb" Inherits="Intranet.EnvioSolicitudCancelacionVacaciones" %>
        ...
        <tr>
            <td align="center">
                <table width="90%">
                    ...
                    <tr>
                        <td align="left" style="width:160px;"><%=TranslateLocale.text("Fechas a Cancelar", EMAIL_LOCALE)%>:</td>
