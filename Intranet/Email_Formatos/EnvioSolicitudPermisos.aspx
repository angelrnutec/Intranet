<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnvioSolicitudPermisos.aspx.vb" Inherits="Intranet.EnvioSolicitudPermisos" %>
        ...
        <tr>
            <td align="center">
                <table width="90%">
                    ...
                    <tr>
                        <td align="left" class="auto-style1"><%=TranslateLocale.text("Gerente", EMAIL_LOCALE)%>:</td>
                        <td align="left" class="auto-style2"><asp:Label ID="lblGerente" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td align="left" class="auto-style1"><%=TranslateLocale.text("Director Area", EMAIL_LOCALE)%>:</td>
                        <td align="left" class="auto-style2"><asp:Label ID="lblDirectorArea" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" style="width:160px;"><%=TranslateLocale.text("Concepto", EMAIL_LOCALE)%>:</td>
                        <td align="left"><asp:Label ID="lblConcepto" runat="server"></asp:Label></td>
                    </tr>
                    <tr id="trViajeProlongado" runat="server" visible="false">
                        <td align="left" style="width:160px;"><%=TranslateLocale.text("Viaje Prolongado", EMAIL_LOCALE)%>:</td>
                        <td align="left"><asp:Label ID="lblFechasViajeProlongado" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
