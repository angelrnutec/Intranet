...
Public Class RepConciliacionVacaciones
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Dim url As String
            url = "RepConciliacionVacacionesImpresion.aspx?id_empresa=" & Me.ddlEmpresa.SelectedValue.ToString & "&solo_diferencias=" & IIf(Me.chkSoloDiferencias.Checked, "1", "0")
