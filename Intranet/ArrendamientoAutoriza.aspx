<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArrendamientoAutoriza.aspx.vb" Inherits="Intranet.ArrendamientoAutoriza" %>
...
<body>
    ...
    <div align="center">
        ...
        <div id="divRechazo" runat="server" visible="false">
            Para guardar el rechazo es obligatorio ingresar el motivo:<br />
