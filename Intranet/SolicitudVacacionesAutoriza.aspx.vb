...
Public Class SolicitudVacacionesAutoriza
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                Try
                    ...
                    seguridad.GuardaLogDatos("EnvioSolicitudVacaciones: " & resultado & "::::" & email_para & "---->" & email_url_base & "/Email_Formatos/EnvioSolicitudVacaciones.aspx?id=" & id_solicitud & "&auth=1")
                Catch ex As Exception
