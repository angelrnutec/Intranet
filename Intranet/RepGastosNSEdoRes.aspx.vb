...
Public Class RepGastosNSEdoRes
    ...
    Private Sub CargaCombos()
        Try
            ...
            'Me.ddlCentroCosto.DataSource = combo.RecuperaCentroCosto(6, "-- Todos --")
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As EventArgs) Handles btnGenerarReporte.Click
        Try
            Dim url As String = ""
            url = "RepGastosNSEdoResImpresion.aspx?e=6&a=" & Me.ddlAnio.SelectedValue & "&m=" & Me.ddlMes.SelectedValue & "&mon=" & Me.ddlMoneda.SelectedValue
