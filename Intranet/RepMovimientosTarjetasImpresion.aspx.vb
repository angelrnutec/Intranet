...
Public Class RepMovimientosTarjetasImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim tipo As String = Request.QueryString("tipo")
            ...
            If Not fec_ini Is Nothing And
                ...
                Dim tabla As DataTable = reporte.ReporteMovimientosTarjetas(fec_ini, fec_fin, id_empresa, tipo, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteMovimientosTarjetas(fec_ini, fec_fin, id_empresa, tipo, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
