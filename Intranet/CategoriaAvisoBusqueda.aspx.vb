...
Public Class CategoriaAvisoBusqueda
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.btnAgregar.Text = TranslateLocale.text("Agregar Nuevo Concepto")
    ...
    Private Sub Busqueda()
        Try
            ...
            Me.gvResultados.DataSource = publicacion.RecuperaCategoriaAvisos()
    ...
    Private Sub gvResultados_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvResultados.RowCommand
        ...
        Try
            ...
            ElseIf e.CommandName = "save" Then
                ...
                If txtDescripcionEn.Text.Trim = "" Then msg += " - Descripción Ingles\n"
                ...
                Dim publicacion As New Publicacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                publicacion.GuardaCategoriaAviso(e.CommandArgument, txtDescripcion.Text.Trim, txtDescripcionEn.Text.Trim, False)
            ...
            ElseIf e.CommandName = "eliminar" Then
                Dim publicacion As New Publicacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
                publicacion.GuardaCategoriaAviso(e.CommandArgument, txtDescripcion.Text.Trim, txtDescripcionEn.Text.Trim, True)
                Me.Busqueda()
            End If
        Catch ex As Exception
            ScriptManager.RegisterStartupScript(Me.Page, Me.Page.GetType, "script", "<script>alert('" & ex.Message.Replace(Chr(34), "").Replace(Chr(39), "") & "');</script>", False)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim publicacion As New Publicacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Dim dv As New DataView(publicacion.RecuperaCategoriaAvisos())
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            If Me.txtDescripcionEn.Text.Trim = "" Then msg += " - Descripción ingles\n"
            ...
            Dim publicacion As New Publicacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            publicacion.GuardaCategoriaAviso(0, Me.txtDescripcion.Text.Trim, Me.txtDescripcionEn.Text.Trim, False)
