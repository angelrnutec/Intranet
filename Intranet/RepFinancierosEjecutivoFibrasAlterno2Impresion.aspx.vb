...
Public Class RepFinancierosEjecutivoFibrasAlterno2Impresion
    ...
    Private Sub CargaTituloReporte()
        Me.lblTituloReporte.Text = TranslateLocale.text("Reporte Ejecutivo - FIBRAS (Presentación 2)")
    End Sub
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not anio Is Nothing And
            ...
            Return reporte.RecuperaReporteEjecutivo(anio, mes, "F", True, True)
        End If
        Return Nothing
    End Function
