...
Public Class RepFinancierosEjecutivoFibrasAlternoImpresion
    ...
    Private Sub CargaTituloReporte()
        Me.lblTituloReporte.Text = TranslateLocale.text("Reporte Ejecutivo - FIBRAS (Presentación)")
    End Sub
    ...
    Protected Function PlanDistribucionEmp(dr As DataRow, mes As Integer, tipo As TipoValor, Optional division As String = "") As Decimal
        Dim nombre_campo As String = "monto_plan"
        If division.Length > 0 Then
            nombre_campo = "monto_plan_emp" & division
        End If
        If tipo = TipoValor.Anual Then
            Return dr(nombre_campo)
        ElseIf tipo = TipoValor.MesActual Then
            Return dr(nombre_campo)
        ElseIf tipo = TipoValor.MesAcumulado Then
            Return (dr(nombre_campo) / 12.0) * mes
        End If
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not anio Is Nothing And
            ...
            Return reporte.RecuperaReporteEjecutivo(anio, mes, "F", True, False)
        End If
        Return Nothing
    End Function
    ...
    Protected Function RecuperaDatosReporteComentario() As DataTable
        ...
        If Not anio Is Nothing And
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.RecuperaReporteEjecutivoComentarios(anio, mes, "F")
        End If
        Return Nothing
    End Function
    ...
    Protected Function NombrePeriodoIngles(periodo As Integer) As String
        Dim nombre As String = ""
    ...
    Protected Function FormateaValorRep1(dt As DataTable, ByRef dr As DataRow, dato As Integer, esTrimestre As Boolean, esPeriodoAnterior As Boolean) As String
        ...
        If dato > 0 Then
            ...
            If dr("es_multivalor") = True Then
                ...
                If dr("id") = 5 Then  'Operational Profit NS
                    If esTrimestre Then
        ...
        ElseIf dato = -1 Then
            ...
            'RM: 210702 cambios para que backlog muestre el dato del mes actual
            If dr("id") = 3 Then
                'dato = mes
                html.AppendLine("<b>" & monto & IIf(dr("es_porcentaje") = True And monto <> "--", "%", "") & "</b>")
                ...
                If dr("es_multivalor") = True Then
                    ...
                    If dr("id") = 5 Then  'Operational Profit NS
                        Dim planAnual = dr("monto_plan" & dato) * dato
    ...
    Protected Function FormateaValorRep3(dr As DataRow, tipo As Integer, columna As Integer, posicion As Integer) As String
        ...
        If tipo = 1 Then
            If columna = 1 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp6")
                monto = dr("monto_emp6")
                If posicion = 1 Then
            ...
            ElseIf columna = 2 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp6")
                monto = dr("monto_ant_emp6")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 3 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp6") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 4 Then
                If dr("monto_ant_emp6") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp6") / dr("monto_ant_emp6")) * 100)
                    If dr("monto_emp6") < dr("monto_ant_emp6") Then
        ...
        ElseIf tipo = 2 Then
            If columna = 5 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp7")
                monto = dr("monto_emp7")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 6 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp7")
                monto = dr("monto_ant_emp7")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 7 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp7") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "7"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 8 Then
                If dr("monto_ant_emp7") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp7") / dr("monto_ant_emp7")) * 100)
                    If dr("monto_emp7") < dr("monto_ant_emp7") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 3 Then
            If columna = 9 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp6") + dr("monto_emp7") - dr("monto_resta_total_6") - dr("monto_resta_total_7")
                monto = dr("monto_emp6") + dr("monto_emp7") - dr("monto_resta_total_6") - dr("monto_resta_total_7")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 10 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp6") + dr("monto_ant_emp7") - dr("monto_resta_total_ant_6") - dr("monto_resta_total_ant_7")
                monto = dr("monto_ant_emp6") + dr("monto_ant_emp7") - dr("monto_resta_total_ant_6") - dr("monto_resta_total_ant_7")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 11 Then
                If (dr("monto_ant_emp7") + dr("monto_ant_emp6") - dr("monto_resta_total_ant_6") - dr("monto_resta_total_ant_7")) <> 0 Then
                    'monto = ((dr("monto_emp7") + dr("monto_emp6") - dr("monto_resta_total")) / (dr("monto_ant_emp7") + dr("monto_ant_emp6") - dr("monto_resta_total_ant")) - 1) * 100

                    porcentaje = Math.Abs(((dr("monto_emp7") + dr("monto_emp6") - dr("monto_resta_total_6") - dr("monto_resta_total_7")) / (dr("monto_ant_emp7") + dr("monto_ant_emp6") - dr("monto_resta_total_ant_6") - dr("monto_resta_total_ant_7")) - 1) * 100)
                    If (dr("monto_emp7") + dr("monto_emp6") - dr("monto_resta_total_6") - dr("monto_resta_total_7")) < (dr("monto_ant_emp7") + dr("monto_ant_emp6") - dr("monto_resta_total_ant_6") - dr("monto_resta_total_ant_7")) Then
                        porcentaje = porcentaje * -1
                    End If
        ...
        ElseIf tipo = 4 Then
            If columna = 13 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp1")
                monto = dr("monto_emp1")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 14 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp1")
                monto = dr("monto_ant_emp1")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 15 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp1") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 16 Then
                If dr("monto_ant_emp1") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp1") / dr("monto_ant_emp1")) * 100)
                    If dr("monto_emp1") < dr("monto_ant_emp1") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 5 Then
            If columna = 17 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp2")
                monto = dr("monto_emp2")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 18 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp2")
                monto = dr("monto_ant_emp2")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 19 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp2") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 20 Then
                If dr("monto_ant_emp2") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp2") / dr("monto_ant_emp2")) * 100)
                    If dr("monto_emp2") < dr("monto_ant_emp2") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 6 Then
            If columna = 21 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp3")
                monto = dr("monto_emp3")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 22 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp3")
                monto = dr("monto_ant_emp3")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 23 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp3") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 24 Then
                If dr("monto_ant_emp3") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp3") / dr("monto_ant_emp3")) * 100)
                    If dr("monto_emp3") < dr("monto_ant_emp3") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 7 Then
            If columna = 25 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp4")
                monto = dr("monto_emp4")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 26 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp4")
                monto = dr("monto_ant_emp4")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 27 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp4") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 28 Then
                If dr("monto_ant_emp4") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp4") / dr("monto_ant_emp4")) * 100)
                    If dr("monto_emp4") < dr("monto_ant_emp4") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 8 Then
            If columna = 29 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp5")
                monto = dr("monto_emp5")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 30 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp5")
                monto = dr("monto_ant_emp5")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 31 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp5") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 32 Then
                If dr("monto_ant_emp5") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp5") / dr("monto_ant_emp5")) * 100)
                    If dr("monto_emp5") < dr("monto_ant_emp5") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
        ...
        ElseIf tipo = 9 Then
            If columna = 33 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8")
                monto = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 34 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8")
                monto = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 35 Then
                If (dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8")) <> 0 Then
                    'monto = ((dr("monto_emp2") + dr("monto_emp1") - dr("monto_resta_total")) / (dr("monto_ant_emp2") + dr("monto_ant_emp1") - dr("monto_resta_total_ant")) - 1) * 100

                    porcentaje = Math.Abs(((dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8")) / (dr("monto_ant_emp2") + dr("monto_ant_emp1") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8")) - 1) * 100)
                    If (dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") - dr("monto_resta_total_1") - dr("monto_resta_total_2")) < (dr("monto_ant_emp2") + dr("monto_ant_emp1") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8")) Then
                        porcentaje = porcentaje * -1
                    End If
        ...
        ElseIf tipo = 10 Then
            If columna = 36 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp8")
                monto = dr("monto_emp8")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 37 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp8")
                monto = dr("monto_ant_emp8")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 38 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp8") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 39 Then
                If dr("monto_ant_emp8") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp8") / dr("monto_ant_emp8")) * 100)
                    If dr("monto_emp8") < dr("monto_ant_emp8") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
    ...
    'Protected Function FormateaValorRep4(dr As DataRow, tipo As Integer, columna As Integer) As String
    '    Dim html As New StringBuilder("")
    '    Dim anio As Integer = Request.QueryString("a")
    '    Dim mes As Integer = Request.QueryString("m")
    ...
    'Dim rep5_monto(50) As Decimal
    'Dim rep5_monto_ant(50) As Decimal
    'Protected Function FormateaValorRep5(dr As DataRow, tipo As Integer, columna As Integer) As String
    '    Dim html As New StringBuilder("")
    '    Dim anio As Integer = Request.QueryString("a")
    '    Dim mes As Integer = Request.QueryString("m")
    '    Dim porcentaje As Integer
    ...
    '    ElseIf tipo = 6 Then
    '        If columna = 16 Then
    '            If dr("id") = 1 Then rep5_monto(columna) = dr("monto1") + dr("monto2") + dr("monto3") + dr("monto4") + dr("monto5")
    '            monto = dr("monto1") + dr("monto2") + dr("monto3") + dr("monto4") + dr("monto5")
    '            html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
    '            If rep5_monto(columna) <> 0 Then
    '                html.AppendLine("<span class='rep4Porc" & IIf((monto / rep5_monto(columna)) < 0, " negativo", "") & "'><i>" & ifNullEmpty((monto / rep5_monto(columna)) * 100) & "</i></span>")
    '            Else
    ...
    '            If dr("id") = 1 Then rep5_monto_ant(columna) = dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5")
    '            monto = dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5")
    '            html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
    '            If rep5_monto_ant(columna) <> 0 Then
    '                html.AppendLine("<span class='rep4Porc" & IIf((monto / rep5_monto_ant(columna)) < 0, " negativo", "") & "'><i>" & ifNullEmpty((monto / rep5_monto_ant(columna)) * 100) & "</i></span>")
    '            Else
    ...
    '            End If
    '        ElseIf columna = 18 Then
    '            If (dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5")) <> 0 Then
    '                'monto = (-1 + (dr("monto1") + dr("monto2") + dr("monto3") + dr("monto4") + dr("monto5")) / (dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5"))) * 100

    '                porcentaje = Math.Abs((-1 + (dr("monto1") + dr("monto2") + dr("monto3") + dr("monto4") + dr("monto5")) / (dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5"))) * 100)
    '                If (dr("monto1") + dr("monto2") + dr("monto3") + dr("monto4") + dr("monto5")) < (dr("monto_ant1") + dr("monto_ant2") + dr("monto_ant3") + dr("monto_ant4") + dr("monto_ant5")) Then
    '                    porcentaje = porcentaje * -1
    '                End If
    ...
    'Protected Function FormateaValorRep7(dr As DataRow, columna As Integer) As String
    '    Dim html As New StringBuilder("")
    '    Dim anio As Integer = Request.QueryString("a")
    '    Dim mes As Integer = Request.QueryString("m")
        ...
        If tipo = 1 Then
            ...
            ElseIf columna = 3 Then
                ...
                Else
                    ...
                    End If
                End If
            ElseIf columna = 101 Then
                If dr("id") = 1 Then rep5_monto_ant(columna) = dr("monto2_plan")
                monto = dr("monto2_plan")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
                    ...
                    End If
                End If
            ElseIf columna = 102 Then
                If dr("monto2_plan") <> 0 Then
                    'monto = (-1 + dr("monto1") / dr("monto_ant1")) * 100

                    porcentaje = Math.Abs((-1 + dr("monto2") / dr("monto2_plan")) * 100)
                    If dr("monto2") < dr("monto2_plan") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep4Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
    ...
    Protected Function FormateaValorRep27(dr As DataRow, tipo As Integer, columna As Integer, posicion As Integer, sufijo As String) As String
        ...
        Dim porcentaje As Integer
        Dim monto As Decimal = 0
        Dim factor = IIf(sufijo = "_fibra", 100, IIf(sufijo = "_fv", 200, IIf(sufijo = "_sat", 300, 400)))
        If tipo = 1 Then
            If columna = 1 Then
        ...
        ElseIf tipo = 10 Then
            'If columna = 28 Then
            '    columna = columna + factor
            '    If dr("id") = 1 Then rep27_monto(columna) = dr("monto1" & sufijo) + dr("monto2" & sufijo) + dr("monto3" & sufijo) + dr("monto4" & sufijo) + dr("monto5" & sufijo) + dr("monto6" & sufijo)
            '    monto = dr("monto1" & sufijo) + dr("monto2" & sufijo) + dr("monto3" & sufijo) + dr("monto4" & sufijo) + dr("monto5" & sufijo) + dr("monto6" & sufijo)
            '    If posicion = 1 Then
            '        html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
            '    End If
            '    If posicion = 2 Then
            ...
            '    columna = columna + factor
            '    If dr("id") = 1 Then rep27_monto_ant(columna) = dr("monto_ant1" & sufijo) + dr("monto_ant2" & sufijo) + dr("monto_ant3" & sufijo) + dr("monto_ant4" & sufijo) + dr("monto_ant5" & sufijo) + dr("monto_ant6" & sufijo)
            '    monto = dr("monto_ant1" & sufijo) + dr("monto_ant2" & sufijo) + dr("monto_ant3" & sufijo) + dr("monto_ant4" & sufijo) + dr("monto_ant5" & sufijo) + dr("monto_ant6" & sufijo)
            '    If posicion = 1 Then
            '        html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
            '    End If
            '    If posicion = 2 Then
            ...
            'ElseIf columna = 30 Then
            '    columna = columna + factor
            '    If (dr("monto_ant1" & sufijo) + dr("monto_ant2" & sufijo) + dr("monto_ant3" & sufijo) + dr("monto_ant4" & sufijo) + dr("monto_ant5" & sufijo) + dr("monto_ant6" & sufijo)) <> 0 Then

            '        porcentaje = Math.Abs((-1 + (dr("monto1" & sufijo) + dr("monto2" & sufijo) + dr("monto3" & sufijo) + dr("monto4" & sufijo) + dr("monto5" & sufijo) + dr("monto6" & sufijo)) / (dr("monto_ant1" & sufijo) + dr("monto_ant2" & sufijo) + dr("monto_ant3" & sufijo) + dr("monto_ant4" & sufijo) + dr("monto_ant5" & sufijo) + dr("monto_ant6" & sufijo))) * 100)
            '        If (dr("monto1" & sufijo) + dr("monto2" & sufijo) + dr("monto3" & sufijo) + dr("monto4" & sufijo) + dr("monto5" & sufijo) + dr("monto6" & sufijo)) < (dr("monto_ant1" & sufijo) + dr("monto_ant2" & sufijo) + dr("monto_ant3" & sufijo) + dr("monto_ant4" & sufijo) + dr("monto_ant5" & sufijo) + dr("monto_ant6" & sufijo)) Then
            '            porcentaje = porcentaje * -1
            '        End If
            '        If posicion = 1 Then
            '            html.AppendLine("<span class='rep4Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
    ...
    Protected Function FormateaValorRep8(dr As DataRow, columna As Integer) As String
        ...
        End If
        'html.AppendLine("<span class='rep4Dato" & IIf(monto < 0, " negativo", "") & "' style='width:45px;'>" & ifNullEmpty(monto) & "</span>")
        html.AppendLine("<span class='rep42Dato" & IIf(monto < 0, " ", "") & "' style='width:45px;'>" & ifNullEmpty(monto) & "</span>")
