...
Public Class RepSolicitudGastosPorCentroCostoImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim modo As String = Request.QueryString("m")
            ...
            If Not id_empresa Is Nothing Then
                ...
                Me.gvReporte.DataSource = reporte.ReporteGastosPorCentroCosto(id_empresa, anio, modo)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteGastosPorCentroCosto(id_empresa, anio, modo)
