...
Public Class RepSolicitudPermisosImpresion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Not fec_ini Is Nothing And
                ...
                Dim tabla As DataTable = reporte.ReporteSolicitudPermisos(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
    ...
    Private Sub SortGridView(sortExpression As String, direction As String)
        Try
            ...
            Dim dt As DataTable = reporte.ReporteSolicitudPermisos(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale()).Tables(0)
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not fec_ini Is Nothing And
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.ReporteSolicitudPermisos(fec_ini, fec_fin, id_empresa, id_estatus, id_empleado, cancelada, Session("idEmpleado"), TranslateLocale.getLocale())
        End If
        Return Nothing
    End Function
