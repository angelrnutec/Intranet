...
Public Class RepFinancierosEjecutivoFibrasImpresion
    ...
    Private Sub CargaTituloReporte()
        Me.lblTituloReporte.Text = TranslateLocale.text("Reporte Ejecutivo - FIBRAS")
    End Sub
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not anio Is Nothing And
            ...
            Return reporte.RecuperaReporteEjecutivo(anio, mes, "F")
        End If
        Return Nothing
    ...
    Protected Function FormateaValorRep3(dr As DataRow, tipo As Integer, columna As Integer, posicion As Integer) As String
        ...
        ElseIf tipo = 9 Then
            If columna = 33 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") + dr("monto_emp9") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8") - dr("monto_resta_total_9")
                monto = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") + dr("monto_emp9") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8") - dr("monto_resta_total_9")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 34 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") + dr("monto_ant_emp9") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9")
                monto = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") + dr("monto_ant_emp9") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 35 Then
                If (dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") + dr("monto_ant_emp9") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9")) <> 0 Then
                    ...
                    If dr("monto_ant_emp2") + dr("monto_ant_emp1") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9") = 0 Then
                        porcentaje = 0
                    Else
                        porcentaje = Math.Abs(((dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") + dr("monto_emp9") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5") - dr("monto_resta_total_8")) / (dr("monto_ant_emp2") + dr("monto_ant_emp1") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") + dr("monto_ant_emp8") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9")) - 1) * 100)
                    End If
                    If (dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") + dr("monto_emp8") + dr("monto_emp9") - dr("monto_resta_total_1") - dr("monto_resta_total_2")) < (dr("monto_ant_emp2") + dr("monto_ant_emp1") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5") - dr("monto_resta_total_ant_8") - dr("monto_resta_total_ant_9")) Then
                        porcentaje = porcentaje * -1
                    End If
        ...
        ElseIf tipo = 11 Then
            If columna = 41 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp9")
                monto = dr("monto_emp9")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
            ...
            ElseIf columna = 42 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp9")
                monto = dr("monto_ant_emp9")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 43 Then
                If dr("datos_extras") = False Then
                    monto = dr("monto_emp9") - (PlanDistribucionEmp(dr, mes, TipoValor.MesAcumulado, "6"))
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                    End If
                End If
            ElseIf columna = 44 Then
                If dr("monto_ant_emp9") <> 0 Then
                    porcentaje = Math.Abs((-1 + dr("monto_emp9") / dr("monto_ant_emp9")) * 100)
                    If dr("monto_emp9") < dr("monto_ant_emp9") Then
                        porcentaje = porcentaje * -1
                    End If
                    If posicion = 1 Then
                        html.AppendLine("<span class='rep2Dato" & IIf(porcentaje < 0, " negativo", "") & "'>" & ifNullEmpty(porcentaje) & "</span>")
