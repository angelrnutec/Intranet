...
Public Class UploadBanner
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            Dim tipo As String = ""
            Dim publicacion As New Publicacion(System.Configuration.ConfigurationManager.AppSettings("CONEXION").ToString())
            ...
            Else
                ...
                filename = Path.GetFileNameWithoutExtension(filename) + "_" + DateTime.Now.ToString("yyMMddHHmmss") + Path.GetExtension(filename)
                ...
                Try
                    Dim imgOrig As Drawing.Image = RezizeImage(Drawing.Image.FromFile(savepath + filename), 260, 600)
                    imgOrig.Save(savepath + "banner/" + Path.GetFileNameWithoutExtension(filename) & "." & ImageFormat.Png.ToString.ToLower(), System.Drawing.Imaging.ImageFormat.Png)
