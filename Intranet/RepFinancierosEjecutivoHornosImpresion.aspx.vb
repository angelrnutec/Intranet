...
Public Class RepFinancierosEjecutivoHornosImpresion
    ...
    Private Sub CargaTituloReporte()
        Me.lblTituloReporte.Text = TranslateLocale.text("Reporte Ejecutivo - HORNOS")
    End Sub
    ...
    Protected Function RecuperaDatosReporte() As DataSet
        ...
        If Not anio Is Nothing And
            ...
            Return reporte.RecuperaReporteEjecutivo(anio, mes, "H")
        End If
        Return Nothing
    End Function
    ...
    Protected Function RecuperaDatosReporteComentario() As DataTable
        ...
        If Not anio Is Nothing And
            ...
            Dim reporte As New Reporte(System.Configuration.ConfigurationManager.AppSettings("CONEXION"))
            Return reporte.RecuperaReporteEjecutivoComentarios(anio, mes, "H")
        End If
        Return Nothing
    End Function
    ...
    'Protected Function FormateaValorRep2(ByRef dr As DataRow, dato As Integer, esTrimestre As Boolean, esTotal As Boolean, esTotalAnt As Boolean) As String
    '    Dim html As New StringBuilder("")
    '    Dim anio As Integer = Request.QueryString("a")
    '    Dim mes As Integer = Request.QueryString("m")
    ...
    'Protected Function FormateaValorRep2Tots(dr As DataRow, tipo As Integer) As String
    '    Dim html As New StringBuilder("")
    '    Dim anio As Integer = Request.QueryString("a")
    '    Dim mes As Integer = Request.QueryString("m")
    ...
    Protected Function FormateaValorRep3(dr As DataRow, tipo As Integer, columna As Integer, posicion As Integer) As String
        ...
        ElseIf tipo = 9 Then
            If columna = 33 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5")
                monto = dr("monto_emp1") + dr("monto_emp2") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 34 Then
                If dr("id") = 1 Then rep3_monto(columna) = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5")
                monto = dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5")
                If posicion = 1 Then
                    html.AppendLine("<span class='rep2Dato" & IIf(monto < 0, " negativo", "") & "'>" & ifNullEmpty(monto) & "</span>")
                End If
                If posicion = 2 Then
            ...
            ElseIf columna = 35 Then
                If (dr("monto_ant_emp1") + dr("monto_ant_emp2") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5")) <> 0 Then
                    ...
                    porcentaje = Math.Abs(((dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") - dr("monto_resta_total_1") - dr("monto_resta_total_2") - dr("monto_resta_total_3") - dr("monto_resta_total_4") - dr("monto_resta_total_5")) / (dr("monto_ant_emp2") + dr("monto_ant_emp1") + dr("monto_ant_emp3") + dr("monto_ant_emp4") + dr("monto_ant_emp5") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5")) - 1) * 100)
                    If (dr("monto_emp2") + dr("monto_emp1") + dr("monto_emp3") + dr("monto_emp4") + dr("monto_emp5") - dr("monto_resta_total_1") - dr("monto_resta_total_2")) < (dr("monto_ant_emp2") + dr("monto_ant_emp1") - dr("monto_resta_total_ant_1") - dr("monto_resta_total_ant_2") - dr("monto_resta_total_ant_3") - dr("monto_resta_total_ant_4") - dr("monto_resta_total_ant_5")) Then
                        porcentaje = porcentaje * -1
                    End If
