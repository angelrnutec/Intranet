<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP.Master" CodeBehind="RepGastosComprobacion.aspx.vb" Inherits="Intranet.RepGastosComprobacion" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTipoSolicitud" runat="server" Width="250px" AutoPostBack="true">
                                <asp:ListItem Value="" Text="--Todos--"></asp:ListItem>
                                <asp:ListItem Value="SV" Text="Gastos de Viaje"></asp:ListItem>
                                <asp:ListItem Value="RG" Text="Reposición de Gastos"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><%=TranslateLocale.text("Elemento PEP")%>:</td>
                        <td><asp:DropDownList ID="ddlElementoPEP" runat="server"></asp:DropDownList></td>
                    </tr>
                    <tr>
