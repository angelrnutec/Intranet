<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepFinancierosCuadreInterImpresionV2.aspx.vb" Inherits="Intranet.RepFinancierosCuadreInterImpresionV2" %>
         ...
         <div id="divReporteNormal" runat="server">
                    ...
                    <asp:GridView ID="gvCapturaCuadreInter" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Afil. x Cob" HeaderStyle-Font-Bold="true" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <div><asp:Label ID="lblImporte01" runat="server" Text='<%# Format(Eval("monto1"), "#,###,##0")%>' ></asp:Label></div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Afil. x Pag" HeaderStyle-Font-Bold="true" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                    ...
                    <asp:GridView ID="gvCapturaCuadreInterRef" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Afil. x Cob" HeaderStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <div>
                            ...
                            <asp:TemplateField HeaderText="Afil. x Pag" HeaderStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <div>
