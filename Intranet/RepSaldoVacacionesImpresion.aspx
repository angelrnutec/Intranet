<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RepSaldoVacacionesImpresion.aspx.vb" Inherits="Intranet.RepSaldoVacacionesImpresion" %>
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr class="filaTotales">
                    <td align="left" style='font-size:18px;padding-left:20px;'><%=TranslateLocale.text("Reporte de Saldo de Vacaciones")%></td>
                </tr>
                <tr>
                ...
                <tr>
                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" HeaderStyle-CssClass="filaTotales titulos" AlternatingRowStyle-BackColor="#FFFFFF">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Saldo Inicial" DataField="saldo_dias" SortExpression="saldo_dias" ItemStyle-HorizontalAlign="Center"/>
