<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/DefaultMP_Wide.Master" CodeBehind="SolicitudGastos.aspx.vb" Inherits="Intranet.SolicitudGastos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <link rel="stylesheet" type="text/css" href="/styles/styles.css" />
                ...
                buttons: {
                    "Guardar Rechazo": function () {
                        if (document.getElementById('txtMotivoRechazo').value == "") {
                            ...
                            window.location = "/SolicitudGastosRechazo.aspx?id=" + document.getElementById('txtIdSolicitudRechazo').value + "&motivo=" + document.getElementById('txtMotivoRechazo').value + "&tipo=" + document.getElementById('txtTipo').value;
                        }
                    },
                    "Cancelar": function () {
                        $(this).dialog("close");
   ...
   <style type="text/css">
    ...
    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Solicitud de Gastos" CssClass="botones" />
    <br /><br /><br />
    ...
    <div id="divMisTareas" runat="server">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    <span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Mis Tareas Pendientes")%></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:ListView ID="lvSolicitudesAuth" runat="server">
                            ...
                            <div>
                                <table class="general" width="950px;" cellpadding="1" cellspacing="0">
                                    <tr class="head">
                                        ...
                                        <th align="left" colspan="2"><asp:LinkButton runat="server" ID="lnkButton3" CommandName="Sort" Text="Acciones" CommandArgument="folio" /></th>
                                    </tr>
                                    <tr class="head3">
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton4" CommandName="Sort" Text="Destino" CommandArgument="destino" /></th>
                                    ...
                                    <tr class="head2">
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton8" CommandName="Sort" Text="Motivo" CommandArgument="motivo" /></th>
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton9" CommandName="Sort" Text="Viajero" CommandArgument="viajero" /></th>
                                        <th align="left" colspan="2"><asp:LinkButton runat="server" ID="lnkButton10" CommandName="Sort" Text="Monto Solicitado" CommandArgument="folio" /></th>
                                    </tr>
                        ...
                        <ItemTemplate>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even")%>">
                                <td><asp:HyperLink ID="lnkFolio" runat="server" NavigateUrl='<%# "SolicitudGastosAgregar.aspx?id=" & Eval("id_solicitud")%>' Text='<%# Eval("folio_txt")%>' ></asp:HyperLink></td>
                            ...
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                <td><asp:Label ID="lblDestino" runat="server" Text='<%# Eval("destino") %>'></asp:Label></td>
                            ...
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                <td><asp:Label ID="lblMotivo" runat="server" Text='<%# Eval("motivo")%>'></asp:Label></td>
                                <td><asp:Label ID="lblViajero" runat="server" Text='<%# Eval("viajero") %>'></asp:Label></td>
                                <td colspan="2">
                                    MXP:&nbsp;<asp:Label ID="lblMontoMXP" runat="server" Text='<%# Format(Eval("monto_pesos"), "###,###,##0.00")%>'></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    USD:&nbsp;<asp:Label ID="lblMontoUSD" runat="server" Text='<%# Format(Eval("monto_dolares"), "###,###,##0.00")%>'></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    EUR:&nbsp;<asp:Label ID="lblMontoEUR" runat="server" Text='<%# Format(Eval("monto_euros"), "###,###,##0.00")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
    ...
    <div id="divGastosPorComprobar" runat="server">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    <span style="font-size:15px; font-weight:bold;"><%=TranslateLocale.text("Mis Gastos Por Comprobar")%></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span style="font-size:12px;font-style:italic;"><%=TranslateLocale.text("(De click en los titulos para sortear los datos)")%></span>
                    &nbsp;&nbsp;&nbsp;
                    ...
                    <asp:ListView ID="lvSolicitudesPorComprobar" runat="server">
                            ...
                            <div>
                                <table class="general" width="950px;" cellpadding="1" cellspacing="0">
                                    <tr class="head">
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton1" CommandName="Sort" Text="Folio" CommandArgument="folio" /></th>
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton2" CommandName="Sort" Text="Empresa" CommandArgument="empresa" /></th>
                                        <th align="left" colspan="2"><asp:LinkButton runat="server" ID="lnkButton3" CommandName="Sort" Text="Viajero" CommandArgument="viajero" /></th>
                                    </tr>
                                    <tr class="head2">
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton4" CommandName="Sort" Text="Destino" CommandArgument="destino" /></th>
                                        <th align="left"><asp:LinkButton runat="server" ID="lnkButton5" CommandName="Sort" Text="Estatus" CommandArgument="estatus" /></th>
                        ...
                        <ItemTemplate>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even")%>">
                                <td><asp:HyperLink ID="lnkFolio" runat="server" NavigateUrl='<%# "SolicitudGastosAgregar.aspx?id=" & Eval("id_solicitud")%>' Text='<%# Eval("folio_txt")%>' ></asp:HyperLink></td>
                                <td><asp:Label ID="lblEmpresa" runat="server" Text='<%# Eval("empresa") %>'></asp:Label></td>
                                <td colspan="2"><asp:Label ID="lblViajero" runat="server" Text='<%# Eval("viajero") %>'></asp:Label></td>
                            </tr>
                            <tr class="<%# If(Container.DisplayIndex Mod 2 = 0, "", "even") %>">
                                <td><asp:Label ID="lblDestino" runat="server" Text='<%# Eval("destino") %>'></asp:Label></td>
                                <td><asp:Label ID="lblEstatus" runat="server" Text='<%# Eval("estatus") %>'></asp:Label></td>
