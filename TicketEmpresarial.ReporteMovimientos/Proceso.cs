...
namespace TicketEmpresarialReporteMovimientos
{
    public static class Proceso
    {
        ...
        public static ProcesoRespuesta ImportarArchivoXML(string archivo)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < nodeList.Count; i++)
                {
                    ...
                    //Se arma el IdMovimiento con la fecha y el # de autorizacion
                    string IdMovimiento = (nodeList[i].Attributes["FechaMovimiento"] != null ? Convert.ToDateTime(nodeList[i].Attributes["FechaMovimiento"].InnerText) : new DateTime(1900, 1, 1)).ToString("yyMMddHHmmss") + (nodeList[i].Attributes["Autorizacion1"] != null ? nodeList[i].Attributes["Autorizacion1"].InnerText : "");

                    movimientos.Add(new Movimiento()
                    {
                        FechaMovimiento = (nodeList[i].Attributes["FechaMovimiento"] != null ? Convert.ToDateTime(nodeList[i].Attributes["FechaMovimiento"].InnerText) : new DateTime(1900, 1, 1)),
                        NumeroTarjeta = (nodeList[i].Attributes["NumeroTarjeta"] != null ? nodeList[i].Attributes["NumeroTarjeta"].InnerText : ""),
                        EstatusTarjeta = (nodeList[i].Attributes["StatusTarjeta"] != null ? nodeList[i].Attributes["StatusTarjeta"].InnerText : ""),
                        Concepto = (nodeList[i].Attributes["Concepto"] != null ? nodeList[i].Attributes["Concepto"].InnerText : ""),
                        Descripcion = (nodeList[i].Attributes["Descripcion"] != null ? nodeList[i].Attributes["Descripcion"].InnerText : ""),
                        TipoComercio = (nodeList[i].Attributes["TipoComercio"] != null ? nodeList[i].Attributes["TipoComercio"].InnerText : ""),
                        RFCComercio = "",
                        IdMovimiento = IdMovimiento,
                        Autorizacion = (nodeList[i].Attributes["Autorizacion1"] != null ? nodeList[i].Attributes["Autorizacion1"].InnerText : ""),
                        NoControlEdoCuenta = "", //values[12],
                        Abono = 0, //decimal.Parse(values[13]),
                        ValorPesos = (nodeList[i].Attributes["Pesos"] != null ? Convert.ToDecimal(nodeList[i].Attributes["Pesos"].InnerText) : 0),
                        ComisionIva = (nodeList[i].Attributes["Comision"] != null ? Convert.ToDecimal(nodeList[i].Attributes["Comision"].InnerText) : 0),
                        ValorMonedaExtranjera = (nodeList[i].Attributes["MonedaExtranjera"] != null ? Convert.ToDecimal(nodeList[i].Attributes["MonedaExtranjera"].InnerText) : 0),
                        DescMonedaExtranjera = (nodeList[i].Attributes["DescMonedaExtranjera"] != null ? nodeList[i].Attributes["DescMonedaExtranjera"].InnerText : ""),
                        TipoCambio = (nodeList[i].Attributes["TipoValorPesos"] != null ? Convert.ToDecimal(nodeList[i].Attributes["TipoValorPesos"].InnerText) : 0)
                    });
                }
